package cn.magikarpll.smsemailclient.utils;

import cn.magikarpll.smsemailclient.entity.VerifyImage;
...
public class ImageCodeGenerateUtils {
     ...
     * 源文件宽度 500
     */
    private static int ORI_WIDTH = 640;

    /**
     * 源文件高度 400
     */
    private static int ORI_HEIGHT = 640;
     ...
     * 抠图内部矩形填充大小
     */
    private static int RECTANGLE_PADDING = 12;
    /**
     * 抠图的边框宽度  固定为1
     */
    ...
    public static void main(String[] args) throws IOException {
        VerifyImage verifyImage = getVerifyImage("F:/Workspace/Company/szse/SmsEmailClient/src/main/resources/test.jpg");

        byte2image(verifyImage.getSrcImage(), "F:/Workspace/Other/test/src.png");
        byte2image(verifyImage.getMarkImage(), "F:/Workspace/Other/test/mark.png");
    }
    ...
    public static VerifyImage getVerifyImage(String filePath) throws IOException {
        ...
        return new VerifyImage(getImageBASE64(srcImage, "jpeg"),getImageBASE64(markImage, "png"),locationX,locationY);
    }
     ...
     * @throws IOException
     */
    public static byte[] getImageBASE64(BufferedImage image, String type) throws IOException {
     ...
     * @return
     */
    public static BufferedImage base64StringToImage(byte[] base64String) {
        try {
            byte[] bytes1 = Base64.encodeBase64(base64String);
